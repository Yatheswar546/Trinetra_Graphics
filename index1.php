    ...
    <div class="banner-container">
            ...
            <ul class="nav-items" id="items-nav">
                ...
                <div class="links">
                    ...
                    <div class="social"> <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                        ...
                        <a href="./admin-panel/admin.html"><i class="fa-solid fa-user"></i></a>
        ...
        <div class="wrapper" id="home">
            <div class="cols cols0">
                ...
                <h1>We Provide <span class="multitext"><!-- Graphic Designing --></span> </h1>
        ...
        <div class="wrapper">
            ...
            <nav>
                <div class="items">
                    ...
                    <span class="item" data-name="graphic">Grpahic Designing</span>
                    <span class="item" data-name="poster">Posters</span>
                    <span class="item" data-name="logo">Logos</span>
                    <span class="item" data-name="video">Videos</span>
                    <span class="item" data-name="brochure">Brochures</span>
                </div>
            </nav>
            <div class="projects">
                ...
                <div class="project" data-name="poster">
                ...
                <div class="project" data-name="logo">
                ...
                <div class="project" data-name="video">
                ...
                <div class="project" data-name="brochure">
            ...
            <div class="teams">
                ...
                <!-- <div class="team-member">
                    <div class="image-content">
                        ...
                        <div class="card-image">
                            <img src="./images/teams/team1.png" alt="" class="card-img">
                        </div>
                    </div>

                    <div class="card-content">
                        <h2 class="name">Parth samthaan</h2>
